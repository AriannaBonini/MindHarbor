...
public class SvolgiTestController {
    ...
    public Double calcolaProgresso(TestResultBean risultatoTest, Date dataTest, String nomeTest) throws DAOException {
        ...
        try {
            ...
            Integer punteggioPassato = new TestPsicologicoDAO().trovaTestPassati(new TestPsicologico(dataTest, risultatoTest.getRisultatoUltimoTest(), null, new Paziente(SessionManager.getInstance().getCurrentUser().getUsername()),nomeTest, null));
